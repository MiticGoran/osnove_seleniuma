...
public class Zadatak1 {
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(500);
        String img1 = new File("test_data/front.jpg").getAbsolutePath();
        String img2 = new File("test_data/right.jpg").getAbsolutePath();
        String img3 = new File("test_data/left.jpg").getAbsolutePath();
        String img4 = new File("test_data/back.jpg").getAbsolutePath();

        driver.findElement(By.className("edit-image")).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated
                (By.xpath("//div[contains(@class, 'sc-eGugkK brCFVr')]")));
        driver.findElement(By.id("imageUpload")).sendKeys(img1);
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated
                (By.xpath("//div[contains(@class, 'sc-eGugkK brCFVr')]")));
        driver.findElement(By.id("imageUpload")).sendKeys(img2);
        wait.until(ExpectedConditions.presenceOfElementLocated
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated
                (By.xpath("//div[contains(@class, 'sc-eGugkK brCFVr')]")));
        driver.findElement(By.id("imageUpload")).sendKeys(img3);
        wait.until(ExpectedConditions.presenceOfElementLocated
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated
                (By.xpath("//div[contains(@class, 'sc-eGugkK brCFVr')]")));
        driver.findElement(By.id("imageUpload")).sendKeys(img4);
        wait.until(ExpectedConditions.presenceOfElementLocated
