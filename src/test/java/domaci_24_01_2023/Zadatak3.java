...
//        Ucitati str https://www.tutorialrepublic.com/snippets/bootstrap/table-with-add-and-delete-row-feature.php
...
public class Zadatak3 {
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            Thread.sleep(500);
            driver.findElement(By.name("name")).sendKeys("Goran Mitic");
            Thread.sleep(500);
            driver.findElement
                            (By.xpath("//table[contains(@class, 'table-bordered')]//tr[last()]//a[@class='add']"))
                    .click();
            Thread.sleep(500);
            ...
            driver.findElement
                    ...
                    .click();
            Thread.sleep(500);
            driver.findElement(By.name("phone")).sendKeys("(069)555-333");
            Thread.sleep(500);
            driver.findElement
                            (By.xpath("//table[contains(@class, 'table-bordered')]//tr[last()]//a[@class='add']"))
                    .click();
